        ...
        <div class="contasiner mx-auto bg-gradient-to-l from-purple-450 to-purple-600 flex">
            <div class="w-1/2">
                <div class="flex justify-center items-center h-full text-3xl font-bold text-gray-100">
                    @lang('app.program_cats_playlists')
                </div>
            </div>
            <div class="w-1/2">
                <div>
        ...
        <div class="container mx-auto text-right">
            <h1
                ...
                : &nbsp; <a href="javascript:void(0);"
                    class="text-purple-450">{{ $programCat->translate('name') }}</a>
            ...
            <div class="w-4/6  p-5">
                ...
                <div class="bg-gray-200 border border-gray-300 p-5 text-right rounded flex flex-wrap justify-center">
                    ...
                    @forelse ($playlists as $playlist)
                        <div class="w-1/2">
                            <div
                                class="bg-white m-3 p-1 border border-gray-300 hover:border-white hover:bg-purple-100 hover:shadow-xl transition">
                                <div class="video-border">
                                    <iframe src="https://www.youtube.com/embed/{{ $playlist->translate('video') }}"
                                        frameborder="0" class="video-iframe w-full h-full" allowfullscreen>
                                    </iframe>
                                    ...
                                    <div class="flex justify-between justify-center mt-2">
                                        ...
                                        <div>
                                            <a href="{{ route('programs', [$playlist->id]) }}"
                                                class="bg-purple-450 hover:bg-black text-white px-2 py-2 transition">
                                                @lang('app.details')
                                            </a>
                                        </div>
