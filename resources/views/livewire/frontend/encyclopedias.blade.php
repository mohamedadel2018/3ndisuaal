...
<x-slot name="meta_description">@lang('app.anddy_soaal') @lang('app.encyclopedia_cats_meta_description')
...
<div>
    <div class="content py-10 h-full bg-gray-200 pt-20">
        ...
        <div class="contasiner mx-auto bg-gradient-to-l from-yellow-600 to-yellow-400 flex">
            <div class="w-1/2">
                <div class="flex justify-center items-center h-full text-3xl font-bold text-gray-800">
                    @lang('app.encyclopedia_cats_questions')
                </div>
            </div>
            <div class="w-1/2">
                <div>
        ...
        <div class="container mx-auto text-right">
            <h1
                class="border-right-yellow p-3 flex justify-end items-center text-md font-bold mx-5  border-b border-gray-300 mt-6">
                : &nbsp; <a href="javascript:void(0);"
                    class="text-yellow-700">{{ $encyclopediaCat->translate('name') }}</a>
        ...
        <div class="container flex mx-auto justify-center flex-wrap">
            <div class="w-2/6  p-5">
                ...
                <div class="bg-gray-200 border border-gray-300 p-5 text-right rounded">
                    <div class=" mb-5 rounded border border-gray-400  shadow-md">
                        <h3 class="p-3 text-center rounded bg-yellow-500 text-black font-bold">
                        ...
                        <ul>
                            @forelse ($encyclopediaCats as $encyclopediaCat)
                                <a href="{{ route('encyclopedias', [$encyclopediaCat->id]) }}">
                                    <li
                                        class="px-2 py-3 border-b rounded hover:bg-yellow-100 hover:text-yellow-900 flex justify-end items-center hover:border-yellow-300 bg-white">
            ...
            <div class="w-4/6  p-5">
                <div class="flex justify-end align-center pt-4 pb-5">
                    <input type="text" placeholder="@lang('app.search')"
                        class="border text-right border-gray-400 focus:ring-2 focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 focus:shadow-lg px-2 py-2 rounded-md text-right shadow-md"
                        wire:model="search">
                </div>
                <div class="bg-gray-200 border border-gray-300 p-5 text-right rounded">
