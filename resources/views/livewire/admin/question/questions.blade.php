...
<x-slot name="breadcrumb">
    ...
    <li class="breadcrumb-item active">@lang('app.questions')</li>
</x-slot>
<div class="w-100">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
           @if (admin()->can('question.view'))
                <a href="{{ route('admin.questions.answered') }}" class="btn btn-success waves-effect waves-light font-weight-bold font-16">
                   @lang('app.answered_questions')
                </a>
           @endif
        </div>
    </div>
