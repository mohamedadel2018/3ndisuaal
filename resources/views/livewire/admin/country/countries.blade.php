...
<x-slot name="breadcrumb">
    ...
    <li class="breadcrumb-item active">@lang('app.countries')</li>
</x-slot>
<div class="w-100">
    <div class="d-flex justify-content-between align-items-center">
      @if (admin()->can('country.create'))
            <a href="{{ route('admin.country.create') }}" class="btn btn-success waves-effect waves-light" >
    ...
    <hr>
    {{-- @include('livewire.admin.country.edit') --}}
