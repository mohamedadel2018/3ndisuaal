...
<div class="w-100">
    <div class="d-flex justify-content-between align-items-center">
        <a href="{{ route('admin.role.create') }}" class="btn btn-success waves-effect waves-light" >
        ...
        <table class="table mb-0 table-bordered table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th>
                        <a  title="@lang('app.edit')" href="{{ route('admin.role.edit',[$role->id]) }}"
                            class="btn btn-primary waves-effect waves-light edit-btn">
                            <i class="la la-edit fz-16"></i>
                        </a>
                        {{-- <a href="{{ route('admin.role.show',[$role->id]) }}" title="@lang('app.details')"
