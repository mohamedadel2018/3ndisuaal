...
<head>
    ...
    <meta content="Mishkatnour" name="description" />
    ...
    <link href="{{ asset('assets/css/admin-rtl.css') }}" rel="stylesheet" type="text/css" />
    @endif
    @livewireStyles
    @stack('css')
</head>
...
<body>
    ...
    <div id="wrapper">
        <!-- Topbar Start -->
        @include('livewire.admin.layouts.top-nav')
        <!-- end Topbar -->

        <!-- ========== Left Sidebar Start ========== -->
        @include('livewire.admin.layouts.menus')
        <!-- Left Sidebar End -->
