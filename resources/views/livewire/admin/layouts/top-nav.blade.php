                            ...
                            <div class="slimscroll noti-scroll">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                    <div class="notify-icon">
                                        <img src="{{ asset('assets/images/users/user-1.jpg') }}" class="img-fluid
        rounded-circle" alt="" />
</div>
...
<ul class="list-unstyled topnav-menu topnav-menu-left m-0">
    ...
    <li class="dropdown d-none d-lg-block">
        ...
        <div class="dropdown-menu">
            <!-- item-->
            <a href="{{ route('admin.languages',['ar']) }}" class="dropdown-item">
                <img class="w-30 h-30 mr-1" src="{{ asset('images/eg.svg') }}" alt="arabic"> @lang('app.arabic')
            </a>

            <!-- item-->
            <a href="{{ route('admin.languages',['en']) }}" class="dropdown-item">
                <img class="w-30 h-30 mr-1" src="{{ asset('images/us.svg') }}" alt="english"> @lang('app.english')

            </a>
            <!-- item-->
            <a href="{{ route('admin.languages',['id']) }}" class="dropdown-item">
                <img class="w-30 h-30 mr-1" src="{{ asset('images/id.svg') }}" alt="indonesia">
                @lang('app.indonesia')
            </a>
        </div>
    </li>
