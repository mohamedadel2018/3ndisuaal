<x-slot name="title">@lang('app.dashboard') | @lang('app.messages')</x-slot>
<x-slot name="pageTitle">@lang('app.messages')</x-slot>
<x-slot name="breadcrumb">
    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">@lang('app.dashboard')</a></li>
    <li class="breadcrumb-item active">@lang('app.messages')</li>
</x-slot>
<div class="w-100">
    <div class="d-flex justify-content-between align-items-center">
        {{-- <a href="{{ route('admin.contact.create') }}" class="btn btn-success waves-effect waves-light">
            ...
            <tbody>
                @forelse ($contacts as $contact)
                    <tr>
                        ...
                        <th>
                            {{-- <a href="{{ route('admin.contact.edit',[$contact->id]) }}" title="@lang('app.edit')" type="button"
                            class="btn btn-primary waves-effect waves-light edit-btn" data-toggle="modal"
                            data-target="#con-edit-modal">
