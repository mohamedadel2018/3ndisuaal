<x-slot name="title">@lang('app.dashboard') | @lang('app.levels')</x-slot>
<x-slot name="pageTitle">@lang('app.levels')</x-slot>
<x-slot name="breadcrumb">
    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">@lang('app.dashboard')</a></li>
    <li class="breadcrumb-item active">@lang('app.levels')</li>
</x-slot>
<div class="w-100">
    <div class="d-flex justify-content-between align-items-center">
       @if (admin()->can('level.create'))
            <a href="{{ route('admin.level.create') }}" class="btn btn-success waves-effect waves-light">
    ...
    <hr>
    {{-- @include('livewire.admin.level.edit') --}}
